...
#include <windows.h> // For SetConsoleTextAttribute (color support)
...
void showMenu() {
    ...
    cout << "\n[7] Join Discord Server: \033[34mhttps://discord.gg/SfkrK75HNj \033[0m (Clickable)\n";
    cout << "\n[8] Start Trainer\n";
    cout << "[9] Exit\n";
    cout << "\nEnter your choice: ";
}
    ...
    do {
        ...
        switch (choice) {
            ...
            case 6:
                ...
                break;
            case 7:
                // Simulate opening the link (can be replaced with actual launch)
                cout << "Opening Discord link... (You can click it manually in the terminal)\n";
                _getch();
                break;
            case 8:
